      ...
      <div className="animate-fade-in-up pb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12 px-4">
          ...
          <div className="lg:col-span-2 glass-panel p-8 rounded-[40px] relative overflow-hidden border-[var(--border-subtle)]">
            ...
            <div className="h-56 flex items-end gap-2 relative">
              {[30, 45, 35, 70, 55, 84, 90, 75, 88, 82, 95, 89].map((h, i) => (
        ...
        <section className="px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { title: "Compliance Cycle Intelligence", date: "Jan 12, 2025", pages: 14, cat: "AUDIT" },
              { title: "Strategic Resource Forecast", date: "Jan 10, 2025", pages: 8, cat: "PLAN" },
              { title: "Faculty Accreditation Deep Dive", date: "Jan 05, 2025", pages: 22, cat: "HR" },
              { title: "Infrastructure Resilience Hub", date: "Dec 28, 2024", pages: 11, cat: "OPS" },
            ].map((item, i) => (
              <div key={i} className="glass-panel p-5 rounded-2xl flex items-center justify-between group cursor-pointer hover:bg-[var(--surface)] transition-all border-[var(--border-subtle)]">
