    ...
    >
      ...
      {isCenter ? (
        <motion.div
          ...
          className="relative"
        >
          {/* Enhanced multi-layer glow for dark mode */}
          ...
          <div className="relative rounded-3xl glass-card p-12 shadow-2xl border border-[var(--glass-border)]">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-4xl font-bold mb-3 bg-gradient-to-r from-primary via-foreground to-blue-400 bg-clip-text text-transparent">
                Horus AI
              </h3>
...
export function HorusIntelligenceSection() {
  ...
  return (
    ...
    >
      {/* Mesh Gradient and subtle grid - Dark Theme */}
      <div className="absolute top-0 left-0 w-full h-[500px] bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.1)_0%,transparent_50%)] pointer-events-none" />
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-[size:100%_40px] opacity-20 pointer-events-none" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-medium mb-4 shadow-[0_0_15px_rgba(99,102,241,0.15)]"
          >
          ...
          >
            One System.{" "}
            <span className="bg-gradient-to-r from-primary via-blue-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(99,102,241,0.4)]">
              One Intelligence.
            </span>
          </motion.h2>
          <motion.p
            ...
            <div className="relative rounded-2xl glass-card border border-[var(--glass-border)] p-6 shadow-2xl">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent mb-1">
                    Horus AI
                  </h3>
