        ...
        <div className="lg:hidden space-y-6">
          ...
          >
            ...
            <div className="relative rounded-2xl border border-white/10 bg-[#0B0F1A]/90 p-6 shadow-2xl backdrop-blur-sm">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-indigo-500/10 to-sky-500/10 border border-indigo-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.1)]">
                  <Brain className="w-8 h-8 text-indigo-400 drop-shadow-[0_0_8px_rgba(99,102,241,0.5)]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold bg-gradient-to-r from-indigo-400 to-sky-400 bg-clip-text text-transparent mb-1">
                    Horus AI
                  </h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <motion.div
              ...
              transition={{ delay: 0.1 }}
            >
              <div className="h-full rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur-md hover:bg-white/10 transition-colors">
